...
public class Indicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public void initDynamicPagerIndicator(Context context, AttributeSet attributeSet) {
        ...
        if (typedArray != null) {
            mTabPadding = (int) typedArray.getDimension(R.styleable.PagerIndicator_tabPadding, 30);
            mTabNormalTextColor = typedArray.getColor(R.styleable.PagerIndicator_tabNormalTextColor, Color.parseColor("#999999"));
            mTabSelectedTextColor = typedArray.getColor(R.styleable.PagerIndicator_tabSelectedTextColor, Color.parseColor("#56E507"));
            mTabNormalTextSize = typedArray.getDimension(R.styleable.PagerIndicator_tabNormalTextSize, Utils.sp2px(mContext, 18));
            mTabSelectedTextSize = typedArray.getDimension(R.styleable.PagerIndicator_tabSelectedTextSize, Utils.sp2px(mContext, 18));
            mTabTextColorMode = typedArray.getInt(R.styleable.PagerIndicator_tabTextColorMode, TAB_TEXT_COLOR_MODE_COMMON);
            mIndicatorLineHeight = (int) typedArray.getDimension(R.styleable.PagerIndicator_indicatorLineHeight, 12);
            mIndicatorLineWidth = (int) typedArray.getDimension(R.styleable.PagerIndicator_indicatorLineWidth, 60);
            mIndicatorLineRadius = typedArray.getDimension(R.styleable.PagerIndicator_indicatorLineRadius, 0);
            mIndicatorLineScrollMode = typedArray.getInt(R.styleable.PagerIndicator_indicatorLineScrollMode, INDICATOR_SCROLL_MODE_DYNAMIC);
            mIndicatorLineStartColor = typedArray.getColor(R.styleable.PagerIndicator_indicatorLineStartColor, Color.parseColor("#f4ce46"));
            mIndicatorLineEndColor = typedArray.getColor(R.styleable.PagerIndicator_indicatorLineEndColor, Color.parseColor("#ff00ff"));
            mIndicatorLineMarginTop = (int) typedArray.getDimension(R.styleable.PagerIndicator_indicatorLineMarginTop, 8);
            mIndicatorLineMarginBottom = (int) typedArray.getDimension(R.styleable.PagerIndicator_indicatorLineMarginBottom, 8);
            mPagerIndicatorMode = typedArray.getInt(R.styleable.PagerIndicator_pagerIndicatorMode, INDICATOR_MODE_FIXED);
            mPagerIndicatorScrollToCenterMode = typedArray.getInt(R.styleable.PagerIndicator_pagerIndicatorScrollToCenterMode, PAGER_INDICATOR_SCROLL_TO_CENTER_MODE_LINKAGE);
            typedArray.recycle();
        }
    }
