 ...
 */
public class LzScrollView extends ScrollView {
    ...
    public LzScrollView(Context context) {
        super(context);
    }

    public LzScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
