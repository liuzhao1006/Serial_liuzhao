 ...
 * 描述     :
 */
public class LzPayload implements Serializable, Cloneable {
    ...
    public LzPayload(int payloadSize) {
    ...
    @Override
    protected LzPayload clone() {
        LzPayload payload;
        try {
            payload = (LzPayload) super.clone();
    ...
    public double getDouble() {
        return Double.doubleToLongBits(getLong());
    }

    @Override
    public String toString() {
        return "MAVLinkPayload{" +
                "payload=" + payload +
                ", index=" + index +
                '}';
    }
